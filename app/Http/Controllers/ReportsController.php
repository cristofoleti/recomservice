...
class ReportsController extends Controller
{
    ...
    public function performance(Request $request){
        ...
        return view('reports.performance', compact('variable', 'company', 'data'));
    }
    ...
    */
    private function readingsPorMes($ano_inicio, $ano_fim, $company){
        ...
        foreach ($periodos as $periodo) {
            ...
            //             "temperatura" => round($readings_mensal->avg_temp_externa,2),
            //             "performance" => round($readings_mensal->avg_kw_tr,2)
            //             ];
            $dados["consumo"][] = round($readings_mensal->avg_consumo,2);
